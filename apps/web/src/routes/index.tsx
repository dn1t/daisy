export default function Index() {
  return (
    <div class="px-6">
      <div class="corner-squircle relative mx-auto h-100 max-w-[calc(var(--container-4xl)+48px)] overflow-clip rounded-2xl border border-zinc-100 bg-[url('/banner.svg')] bg-brand bg-cover supports-corner-shape:rounded-4xl">
        <div class="flex h-full w-full flex-col justify-end bg-linear-[8deg] from-20% from-[color-mix(in_hsl,var(--color-brand),black_20%)] to-brand/0 px-8 py-6.5">
